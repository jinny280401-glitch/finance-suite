...
version: 1.0.0
description: >
  天玑 — 金融数据全景分析引擎（内部技能名 finance-suite）。7大技能：看票分析、宏观内参、麦肯锡报告、视频拆解、深度研究(行业+公司)、集合竞价、自选股管理。
...
Vera 可调用的金融研究功能路由层，内部技能名 `finance-suite`。7 大专业分析技能，集成 Wind 优先 / AkShare 降级、双搜索引擎与视频字幕提取。
