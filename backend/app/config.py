...
# Project root: backend/app/ is two levels below root
...
class Settings:
    ...
    def __init__(self):
        ...
        self.LOG_DIR: Path = Path(os.getenv("LOG_DIR", str(BASE_DIR / "logs")))
        self.SCRIPTS_DIR: Path = BASE_DIR / "scripts"
        self.STATIC_DIR: Path = BASE_DIR / "frontend" / "static"
        self.TEMPLATES_DIR: Path = BASE_DIR / "frontend" / "templates"
        # Qwen API
