...
# 内测账号（从前端硬编码迁移）
python3 manage_users.py add linzuxi <REMOVED_SECRET> vip
python3 manage_users.py add danny ***REDACTED*** vip
python3 manage_users.py add ivan ***REDACTED*** vip
python3 manage_users.py add shengwei <REMOVED_SECRET> vip
python3 manage_users.py add demo <REMOVED_SECRET> free
python3 manage_users.py add zhuanz <REMOVED_SECRET> admin
python3 manage_users.py add vanilla ***REDACTED*** vip
python3 manage_users.py add nanjian ***REDACTED*** vip
python3 manage_users.py add fengzhijie ***REDACTED*** vip
python3 manage_users.py add lianghailin ***REDACTED*** vip
...
2. 点击"进入工作台"
3. 使用任意账号登录（如 demo / <REMOVED_SECRET>）
4. 检查是否能正常进入工作台
